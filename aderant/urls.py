...
urlpatterns = [
    ...
    path('adherant/<int:adherant_id>/export/pdf/', views.export_adherant_detail_pdf, name='export_adherant_detail_pdf'),
    path('export/all/', views.export_adherants_csv, name='export_adherants_all'),
    path('export/all/pdf/', views.export_adherants_pdf, name='export_adherants_pdf'),
